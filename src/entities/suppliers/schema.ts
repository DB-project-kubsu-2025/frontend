...
export const SuppliersListNormalizedSchema = SuppliersListFormSchema.transform(v => {
  return {
    id: toInt(v.id),
    name: v.name,
    address: v.address,
...
export const SuppliersDetailNormalizedSchema = SuppliersDetailFormSchema.transform(v => {
  return {
...
export type SuppliersListNormalized = z.infer<typeof SuppliersListNormalizedSchema>;
export type SuppliersDetailNormalized = z.infer<typeof SuppliersDetailNormalizedSchema>;
